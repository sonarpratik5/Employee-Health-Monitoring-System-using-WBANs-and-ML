...
//     $isp_select = $_POST['isp_id'];
    ...
    $update_data = "UPDATE employee SET name='$name', address='$address',
  phone='$phone',designation='$designation',country='$country', email = '$email' WHERE id='$edit_id'";
    //print_r($Id); die();
    ...
    { ?>
      <script type="text/javascript">
        ...
        window.open("http://localhost/pict/employees.php","_self");
      </script>
      <?php
    }
    else
