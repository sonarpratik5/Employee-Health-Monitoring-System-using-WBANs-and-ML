    ...
    <div class="col-xl-5">
      ...
      <div class="tab-pane fade show active profile-overview">
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8" style="font-size: 13px;">Pratik Sonar</div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label" style="font-size: 13px;">Company</div>
                <div class="col-lg-9 col-md-8" style="font-size: 13px;">Lueilwitz, Wisoky and Leuschke</div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label" style="font-size: 13px;">Job</div>
                <div class="col-lg-9 col-md-8" style="font-size: 13px;">Web Designer</div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label" style="font-size: 13px;">Country</div>
                <div class="col-lg-9 col-md-8" style="font-size: 13px;">USA</div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label" style="font-size: 13px;">Address</div>
                <div class="col-lg-9 col-md-8" style="font-size: 13px;"    >A108 Adam Street, New York, NY 535022</div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label" style="font-size: 13px;">Phone</div>
                <div class="col-lg-9 col-md-8" style="font-size: 13px;">(436) 486-3538 x29071</div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label" style="font-size: 13px;">Email</div>
                <div class="col-lg-9 col-md-8" style="font-size: 13px;">k.anderson@example.com</div>
              </div>
          ...
          <div class="tab-content pt-2">
            ...
            <h5 class="card-title">Doctor's Remark</h5>
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8">Yes</div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8">Diabetic, Cholesterol</div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label">Allergies</div>
                <div class="col-lg-9 col-md-8">Dairy</div>
              </div>
              <div class="row">
                <div class="col-lg-3 col-md-4 label">Height</div>
                <div class="col-lg-9 col-md-8">176.5</div>
              </div>
              <div class="row">
                <div class="col-lg-3 col-md-4 label">Weight</div>
                <div class="col-lg-9 col-md-8">78 Kg</div>
              </div>
              <div class="row">
