...
$country = $_REQUEST['country'];
        ...
        $check=mysqli_query($conn,"select * from doctor where email='$email'");
       ...
       {
          $query    = "INSERT into doctor (name, designation, country, address, phone, email, password, user_type)
                       VALUES ('$name','$designation','$country', '$address', '$phone', '$email','$password', 1)";
            ...
            <div class="card-body">
              ...
              <form>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="designation" placeholder="Doctor">
                  </div>
                </div>
                <div class="row mb-3">
