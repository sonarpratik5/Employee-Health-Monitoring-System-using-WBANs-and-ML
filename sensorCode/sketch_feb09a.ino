...
#define WIFISSID "$anket" // Enter WifiSSID here
#define PASSWORD "00000000" // Enter password here
#define TOKEN "BBFF-KVfPNLf1CGbQWkz4gLPI1R1b2FQyzC" // Ubidots' TOKEN
#define MQTT_CLIENT_NAME "sanketshinde" // MQTT client Name
// * Define Constants
#define VARIABLE_LABEL "ecg_read" // ubidots variable label
